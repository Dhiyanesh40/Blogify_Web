    ...
    <div className="min-h-screen bg-gradient-hero">
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <Card className="relative bg-gradient-card shadow-elegant border border-border/50 overflow-hidden">
            {blog.verified && (
            ...
            {blog.background_image_url && (
              <div className="h-64 w-full bg-cover bg-center" style={{ backgroundImage: `url(${blog.background_image_url})` }} />
            )}
