...
export const BlogCard = ({ 
  ...
  return (
    ...
    >
      <Link to={`/blog/${id}`}>
        <Card className="relative h-full bg-gradient-card hover:shadow-card transition-all duration-300 border border-border/50 hover:border-primary/20 overflow-hidden">
          {verified && (
          ...
          {backgroundImageUrl && (
            <div className="h-40 w-full bg-cover bg-center" style={{ backgroundImage: `url(${backgroundImageUrl})` }} />
          )}
